...
class DrugDescription extends StatefulWidget {
  const DrugDescription({super.key, required this.drugid});
  final String drugid;
  @override
  State<DrugDescription> createState() => _DrugDescriptionState();
}
...
class _DrugDescriptionState extends State<DrugDescription> {
  ...
  Future<void> updateDrugField(int type, int index, String newValue) async {
    String field = type == 1 ? 'descriptionArabic' : 'descriptionEnglish';
    var drugDocRef =
                          ...
                          child: Column(
                            children: [
                              ...
                              DrugsData.isNotEmpty &&
                                      drug != null &&
                                      ArabicdescriptionList.isNotEmpty &&
                                      EnglishdescriptionList.isNotEmpty
                                  ? ListView.builder(
                                      physics:
                                          const NeverScrollableScrollPhysics(),
                                      shrinkWrap: true,
                                      itemCount: ArabicdescriptionList.length,
                              ...
                              DrugsData.isNotEmpty &&
                                  ...
                                  ? ListView.builder(
                                      physics:
                                          const NeverScrollableScrollPhysics(),
                                      shrinkWrap: true,
                                      itemCount: EnglishdescriptionList.length,
                                      itemBuilder: (context, index) {
                                        return ListTile(
                                          leading: const Icon(
                                            Icons.circle,
